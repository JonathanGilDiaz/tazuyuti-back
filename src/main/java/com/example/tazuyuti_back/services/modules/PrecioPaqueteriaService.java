...
public interface PrecioPaqueteriaService {

    ResponseEntity<Response> save(PrecioPaqueteria precioPaqueteriaService, HttpServletRequest request);

    ResponseEntity<Response> index(Pagination request);

    ResponseEntity<Response> detail(int id);

    ResponseEntity<Response> update(PrecioPaqueteria precioPaqueteriaService, HttpServletRequest request);
