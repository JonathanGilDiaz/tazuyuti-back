...
@Entity
@ToString
@Table(schema = "modulos", name = "recibir_paquete")
public class RecibirPaquete {
    ...
    @NotNull(groups = {onCreate.class, onUpdate.class}, message = "observaciones es requerido")         
    @Schema(description = "observaciones", example = "Mi carro")        
